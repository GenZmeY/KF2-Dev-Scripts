...
// KFPawn_HRG_Warthog
//=============================================================================
// Base pawn class for HRG Warthog
//=============================================================================
// 2022!
//=============================================================================
class KFPawn_HRG_Warthog extends KFPawn
	notplaceable;
...
var transient KFWeap_HRG_WarthogWeapon TurretWeapon;
var transient KFWeapAttach_HRG_WarthogWeap TurretWeaponAttachment;

var transient KFWeap_HRG_Warthog OwnerWeapon;
...
simulated event PreBeginPlay()
{
    ...
    WeaponClass = class<KFWeap_HRG_WarthogWeapon> (DynamicLoadObject(WeaponDefinition.default.WeaponClassPath, class'Class'));
...
simulated state Detonate
{
    ...
    function TriggerExplosion()
    {
        ...
        MyProjectileClass = class'KFProj_HighExplosive_HRG_Warthog';
            ...
            && Instigator.IsLocallyControlled()) )
        {
            ...
            for (i = 0; i < DetonateNumberOfProjectiles; ++i)
            {
                ...
                Projectile = KFProj_HighExplosive_HRG_Warthog(TurretWeapon.SpawnProjectile(class'KFProj_HighExplosive_HRG_Warthog', StartTrace, AimDir));
...
{
    local KFWeap_HRG_Warthog WeapOwner;

    StopIdleSound();

    WeapOwner = KFWeap_HRG_Warthog(Owner);
...
defaultproperties
{
    ...
    Begin Object Class=KFGameExplosion Name=ExploTemplate0
		...
		// Damage Effects
		MyDamageType=class'KFDT_Explosive_HRG_Warthog'
		KnockDownStrength=0
    ...
    WeaponDefinition=class'KFGame.KFWeapDef_HRG_WarthogWeapon'
